...
return [
    ...
    */
    ...
    'alpha_dash' => 'يجب أن يحتوي حقل :attribute على أحرف وأرقام وشرطات وعلامات تسطير فقط.',
    ...
    'lte' => [
        ...
        'string' => 'يجب أن يكون طول النص :attribute أصغر من أو يساوي :value حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهرت :attribute المقدمة في تسريب بيانات. الرجاء اختيار :attribute مختلفًا.',
    ],
    ...
    'prohibits' => 'يمنع حقل :attribute :other من أن يكون موجودًا.',
    ...
    */
    ...
    'custom' => [
        'password' => [
            'custom_password' => 'يجب أن تتكون :attribute من 8 أحرف على الأقل ويجب أن تحتوي على أحرف وأرقام ورموز.',
            'invalid' => ':attribute المذكورة غير صالحة.',
        ],
        'profile_picture' => [
            'custom_image' => 'يجب أن يكون حقل :attribute صورة ويجب أن يكون ملفًا من النوع: jpeg، jpg، png.',
        ],
        'file' => [
            'custom_file' => 'يجب أن يكون حقل :attribute ملفًا ويجب أن يكون ملفًا من النوع: pdf',
        ],
    ],
